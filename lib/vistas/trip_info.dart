...
//import 'package:google_maps/home/trip_end.dart';
import 'package:conectcarga/tools/CustomTextStyle.dart';
import 'package:conectcarga/tools/DottedLine.dart';
...
class TripInfo extends StatefulWidget {
  TripInfo({Key key, this.carServices}) : super(key: key);
...
class _TripInfoState extends State<TripInfo> {
  ...
  _TripInfoState({this.carServices});

  Color _colorVal;
  /*var _ahmedabad = LatLng(6.225, -75.5414);
